...
{
    [DbContext(typeof(CAFMDbContext))]
    partial class CAFMDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CAFM.Database.Entities.Asset", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CAFM.Database.Entities.ErrorsLog", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CAFM.Database.Entities.Messages_System", b =>
                {
            ...
            modelBuilder.Entity("CAFM.Database.Entities.TaskPriority", b =>
                {
            ...
            modelBuilder.Entity("CAFM.Database.Entities.TaskStatue", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CAFM.Database.Entities.WorkOrder", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CAFM.Database.Entities.WorkOrderDetail", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CAFM.Database.Entities.WorkOrder", b =>
                {
                    b.HasOne("CAFM.Database.Entities.Asset", "Asset")
                        .WithMany("WorkOrders")
                        .HasForeignKey("AssetId")
                        .HasConstraintName("FK_WorkOrders_Assets");

                    b.HasOne("CAFM.Database.Entities.TaskPriority", "Priority")
                        .WithMany("WorkOrders")
                        .HasForeignKey("PriorityId")
                        .IsRequired()
                        .HasConstraintName("FK_WorkOrders_TaskPriorities");

                    b.HasOne("CAFM.Database.Entities.TaskStatue", "TaskStatus")
                        .WithMany("WorkOrders")
            ...
            modelBuilder.Entity("CAFM.Database.Entities.WorkOrderDetail", b =>
                {
                    b.HasOne("CAFM.Database.Entities.WorkOrder", "WorkOrder")
