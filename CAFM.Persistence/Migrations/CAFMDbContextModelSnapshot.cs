...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CAFM.Domain.Models.Asset", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CAFM.Domain.Models.ErrorsLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CAFM.Domain.Models.MessagesSystem", b =>
                {
            ...
            modelBuilder.Entity("CAFM.Domain.Models.TaskPriority", b =>
                {
            ...
            modelBuilder.Entity("CAFM.Domain.Models.TaskStatue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CAFM.Domain.Models.WorkOrder", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CAFM.Domain.Models.WorkOrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CAFM.Domain.Models.WorkOrder", b =>
                {
                    b.HasOne("CAFM.Domain.Models.Asset", "Asset")
                        .WithMany("WorkOrders")
                        .HasForeignKey("AssetId")
                        .HasConstraintName("FK_WorkOrders_Assets");

                    b.HasOne("CAFM.Domain.Models.TaskPriority", "Priority")
                        .WithMany("WorkOrders")
                        .HasForeignKey("PriorityId")
                        .IsRequired()
                        .HasConstraintName("FK_WorkOrders_TaskPriorities");

                    b.HasOne("CAFM.Domain.Models.TaskStatue", "TaskStatus")
                        .WithMany("WorkOrders")
            ...
            modelBuilder.Entity("CAFM.Domain.Models.WorkOrderDetail", b =>
                {
                    b.HasOne("CAFM.Domain.Models.WorkOrder", "WorkOrder")
